    ...
    <div className="space-y-8">
      ...
      <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
        ...
        <div className="px-4 py-4 sm:px-6 space-y-3 text-sm text-gray-700">
          <p>
            <span className="font-semibold text-gray-900">Codepage 1252</span>{" "}
            (also known as Windows-1252) is a single-byte character encoding
            used extensively in legacy systems, including many healthcare claim
            processing platforms. It supports 251 characters in the range
            0x00–0xFF, with five undefined positions (0x81, 0x8D, 0x8F, 0x90,
            0x9D).
          </p>
          <p>
            When modern applications allow users to enter Unicode characters —
            such as smart quotes (" "), em dashes (—), Euro signs (€), or other
            symbols — these characters may fall outside the valid Codepage 1252
            range. If submitted to downstream systems that expect Codepage 1252
            encoding, these characters can cause data corruption, processing
            failures, or rejected claims.
          </p>
          <p>
            <span className="font-semibold text-gray-900">
              Why validation matters:
            </span>{" "}
            By validating input against Codepage 1252 before submission, we can
            catch encoding issues early, provide clear feedback to users about
            which characters are invalid, and prevent costly downstream failures
            in claim processing pipelines.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="rounded-lg border border-gray-200 bg-white shadow-sm flex flex-col">
            ...
            <div className="px-4 py-4 sm:px-6 flex-1">
              ...
              <p className="text-sm text-gray-600">
                Demonstrates the current behavior where all characters are
                accepted without Codepage 1252 checks. Any Unicode character can
                be submitted, including characters that may cause encoding
                issues downstream. Use this screen to see what happens when
          ...
          <div className="rounded-lg border border-gray-200 bg-white shadow-sm flex flex-col">
            ...
            <div className="px-4 py-4 sm:px-6 flex-1">
              ...
              <p className="text-sm text-gray-600">
                Demonstrates the future state where all form fields are
                validated against Codepage 1252 encoding on submission. Invalid
                characters are flagged with detailed error messages showing the
                character, its Unicode code point, and position. Compare with
                Screen A to see the difference.
              </p>
            </div>
            <div className="px-4 py-4 sm:px-6 border-t border-gray-100">
              <Link
          ...
          <div className="rounded-lg border border-gray-200 bg-white shadow-sm flex flex-col">
            ...
            <div className="px-4 py-4 sm:px-6 flex-1">
              ...
              <p className="text-sm text-gray-600">
                View simulated monitoring data including failure statistics,
                trend charts, alert banners, and validation logs. All data is
                generated locally based on validation activity within the demo.
                Submit forms on Screen A and Screen B to generate events that
                appear here.
              </p>
            </div>
            <div className="px-4 py-4 sm:px-6 border-t border-gray-100">
          ...
          <ol className="space-y-4">
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Both screens are pre-populated with realistic fake claim data
                  that intentionally contains non-Codepage 1252 characters such
                  as smart quotes, em dashes, and Unicode symbols.
                </p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  On Screen A, all input is accepted without validation. On
                  Screen B, each field is checked against the Codepage 1252
                  character set before submission is accepted.
                </p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  When validation is enabled (Screen B), invalid characters are
                  highlighted with their Unicode code points and positions.
                  Validation failures are logged and tracked on the Monitoring
                  Dashboard.
                </p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  The Monitoring Dashboard displays failure statistics, trend
                  charts, and simulated alerts based on validation activity. All
                  data persists in localStorage for the duration of the demo
                  session.
                </p>
              </div>
            </li>
